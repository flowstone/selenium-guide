...
// 市
const zone3Value = $('#zone3').val();
// 县
const zone4Value = $('#zone4').val();
// 乡
const zone5Value = $('#zone5').val();
const zone5Title = $('#zone5').attr('title');
...
// 文化
const educationStatusValue = $('#educationStatus').val();
// 职业
...
function goStudy() {
    ...
    const getExamRequestParamsJson = {
        "examType": examType,
        "lxType": lxType,
        "studentLevel": metierValue + "," + studentLevel,
    ...
    */
    ...
    new Promise((resolve, rejects) => {
        ...
        const submitExamRequestParamsJson = {
            ...
            "taPaperList.sex": sexValue,
            "taPaperList.ageGroup": ageGroupValue,
            "taPaperList.marriageStatus": marriageStatus,
            "taPaperList.educationStatus": educationStatusValue,
    ...
    function setExamSubmitParams() {
        ...
        taPaperListMetier = metierValue;
        // 职业不是学生时，为0
        taPaperListStudentLevel = studentLevel;
        //性别
        taPaperListSex = sexValue;
        // 年龄
        taPaperListAgeGroup = ageGroupValue;
        // 婚姻状态
        taPaperListMarriageStatus = marriageStatus;
        // 文化程度
        taPaperListEducationStatus = educationStatusValue;
        // 收入状态
        ...
        // 街道编号
        taPaperListZone = zone5Value;
        // 单位
        taPaperListOrgName = orgName;
        // 姓名
        taPaperListLogonname = firstnameValue;
        taPaperListPwd = "";
        taPaperListCardNumber = "";
        taPaperListLinkphone = "";
        // 街道
        taPaperListZoneName = zone5Title;
